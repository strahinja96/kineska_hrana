...
{
    public partial class Uloge_upravljanje : System.Web.UI.Page
    {
        ...
        protected void linkUnesi_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                SqlDataSource1.InsertParameters["nazivUloga"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("tbNazivUloga")).Text;
                ...
                op.DogadjajObj.DogadjajOpis = "Korisnik je uneo novu ulogu!";
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            op.DogadjajObj = new DogadjajDb();
            op.DogadjajObj.IdKorisnik = idKorisnik;
            op.DogadjajObj.DogadjajOpis = "Korisnik je promenio ulogu sa identifikatorom " + identifikator + "!";
            op.DogadjajObj.Vreme = DateTime.Now;
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            op.DogadjajObj = new DogadjajDb();
            op.DogadjajObj.IdKorisnik = idKorisnik;
            op.DogadjajObj.DogadjajOpis = "Korisnik je obrisao ulogu sa identifikatorom " + identifikator + "!";
            op.DogadjajObj.Vreme = DateTime.Now;
